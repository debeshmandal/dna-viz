...
//! [0]
void DNAVIZ::Viewer::mousePressEvent(QMouseEvent *e)
{
...
void DNAVIZ::Viewer::initializeGL()
{
...
//! [3]
void DNAVIZ::Viewer::initShaders()
{
    // Compile vertex shader
    if (!program.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/opengl/shaders/vshader.glsl"))
        close();

    // Compile fragment shader
    if (!program.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/opengl/shaders/fshader.glsl"))
        close();
